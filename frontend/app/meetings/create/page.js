         ...
         <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
          ...
          <div>
            ...
            <input 
              ...
              className='w-full px-4 py-2 border border-[var(--border-light)] rounded-lg focus:border-[var(--text-accent)] focus:outline-none'
            />
